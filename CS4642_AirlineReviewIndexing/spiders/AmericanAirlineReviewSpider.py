...
class AmericanAirlineReviewSpider(scrapy.Spider):
    name = "AmericanAirlineReviewSpider"
    allowed_domains = ["airlineratings.come"]
    start_urls = ["https://www.airlineratings.com/passenger-reviews/american-airlines/"]
